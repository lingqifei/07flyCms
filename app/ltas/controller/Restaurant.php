...
class Restaurant extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        $list =$this->logicRestaurant->getRestaurantList($where,true,$order_by)->toArray();
        return $list;
    }
    ...
    public function add()
    {
        ...
        IS_POST && $this->jump($this->logicRestaurant->restaurantAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicRestaurant->restaurantEdit($this->param));

        $info = $this->logicRestaurant->getRestaurantInfo(['id' => $this->param['id']]);
    ...
    public function del()
    {
        ...
        $this->jump($this->logicRestaurant->restaurantDel($where));
    }
    /**
     * 排序
     */
    ...
    {
        $this->jump($this->logicLtasBase->setSort('Restaurant', $this->param));
    }
}
