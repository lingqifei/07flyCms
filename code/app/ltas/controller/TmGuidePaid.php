...
class TmGuidePaid extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        $list =$this->logicTmGuidePaid->getTmGuidePaidList($where);
    ...
    public function add()
    {
        ...
        IS_POST && $this->jump($this->logicTmGuidePaid->tmGuidePaidAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicTmGuidePaid->tmGuidePaidEdit($this->param));

        $where['id']=["=", $this->param['id']];

        $info     = $this->logicTmGuidePaid->getTmGuidePaidInfo($where);
    ...
    public function del()
    {
        ...
        $this->jump($this->logicTmGuidePaid->tmGuidePaidDel($where));
    }
