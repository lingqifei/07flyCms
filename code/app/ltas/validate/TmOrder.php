...
class TmOrder extends LtasBase
{
    ...
    protected $scene = [
        ...
        'add'       =>  ['line_name','agency_id','saleman_id','tourist_name','days_id','arrive_date','all_num'],
        'edit'       =>  ['line_name','agency_id','saleman_id','tourist_name','days_id','arrive_date','all_num'],
//        'add'       =>  ['line_id','agency_id','saleman_id','tourist_name','arrive_train_name','arrive_station_name','days_id','leave_train_name','leave_station_name','send_mode','arrive_date'],
