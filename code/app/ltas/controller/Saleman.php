...
class Saleman extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        $list =$this->logicSaleman->getSalemanList($where,true,$order_by)->toArray();
        return $list;
    }
    ...
    public function add()
    {
        ...
        IS_POST && $this->jump($this->logicSaleman->salemanAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicSaleman->salemanEdit($this->param));

        $info = $this->logicSaleman->getSalemanInfo(['id' => $this->param['id']]);
    ...
    public function del()
    {
        ...
        $this->jump($this->logicSaleman->salemanDel($where));
    }
    /**
     * 排序
     */
    ...
    {
        $this->jump($this->logicLtasBase->setSort('Saleman', $this->param));
    }
}
