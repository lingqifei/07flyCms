...
class SkGuideReceipt extends LtasBase
{
    ...
    protected $message  =   [
        ...
        'item_receipt_id.require'      => '回执单选项不能为空',
    ...
    protected $scene = [
        ...
        'add'       =>  ['adult_price','adult_num','child_price','child_num','total_price'],
        'edit'       =>  ['adult_price','adult_num','child_price','child_num','total_price'],
