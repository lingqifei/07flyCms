...
class TmGuideFood extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        $list =$this->logicTmGuideFood->getTmGuideFoodList($where);
    ...
    public function add()
    {
        ...
        IS_POST && $this->jump($this->logicTmGuideFood->tmGuideFoodAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicTmGuideFood->tmGuideFoodEdit($this->param));

        $where['id']=["=", $this->param['id']];

        $info     = $this->logicTmGuideFood->getTmGuideFoodInfo($where);
    ...
    public function del()
    {
        ...
        $this->jump($this->logicTmGuideFood->tmGuideFoodDel($where));
    }
