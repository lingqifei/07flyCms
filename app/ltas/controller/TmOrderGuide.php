...
class TmOrderGuide extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        $list =$this->logicTmOrderGuide->getTmOrderGuideList($where,$field ="*", $order = 'sort asc', $paginate = 100);
        return $list;
    }
    ...
    public function add()
    {
        ...
        IS_POST && $this->jump($this->logicTmOrderGuide->tmOrderGuideAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicTmOrderGuide->tmOrderGuideEdit($this->param));
    ...
    public function del()
    {
        ...
        $this->jump($this->logicTmOrderGuide->tmOrderGuideDel($where));
    }
