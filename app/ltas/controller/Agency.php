...
class Agency extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        $list =$this->logicAgency->getAgencyList($where,true,$order_by)->toArray();
        return $list;
    }
    ...
    public function add()
    {
        ...
        IS_POST && $this->jump($this->logicAgency->agencyAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicAgency->agencyEdit($this->param));

        $info = $this->logicAgency->getAgencyInfo(['id' => $this->param['id']]);
    ...
    public function del()
    {
        ...
        $this->jump($this->logicAgency->agencyDel($where));
    }
    /**
     * 排序
     */
    ...
    {
        $this->jump($this->logicLtasBase->setSort('Agency', $this->param));
    }
}
