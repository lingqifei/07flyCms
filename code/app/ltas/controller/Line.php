...
class Line extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        $list =$this->logicLine->getLineList($where,true,$order_by);
        return $list;
    }
    ...
    public function add()
    {
        ...
        IS_POST && $this->jump($this->logicLine->lineAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicLine->lineEdit($this->param));

        $info = $this->logicLine->getLineInfo(['id' => $this->param['id']]);
    ...
    public function del()
    {
        ...
        $this->jump($this->logicLine->lineDel($where));
    }
    /**
     * 排序
     */
    ...
    {
        $this->jump($this->logicLtasBase->setSort('Line', $this->param));
    }
}
