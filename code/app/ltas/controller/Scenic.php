...
class Scenic extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        $list =$this->logicScenic->getScenicList($where,true,$order_by)->toArray();
        return $list;
    }
    ...
    public function add()
    {
        ...
        IS_POST && $this->jump($this->logicScenic->scenicAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicScenic->scenicEdit($this->param));

        $info = $this->logicScenic->getScenicInfo(['id' => $this->param['id']]);
    ...
    public function del()
    {
        ...
        $this->jump($this->logicScenic->scenicDel($where));
    }
    /**
     * 排序
     */
    ...
    {
        $this->jump($this->logicLtasBase->setSort('Scenic', $this->param));
    }
}
