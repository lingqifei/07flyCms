...
class Hotel extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        $list =$this->logicHotel->getHotelList($where,true,$order_by);
        return $list;
    }
    ...
    public function add()
    {
        ...
        IS_POST && $this->jump($this->logicHotel->hotelAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicHotel->hotelEdit($this->param));

        $info = $this->logicHotel->getHotelInfo(['id' => $this->param['id']]);
    ...
    public function del()
    {
        ...
        $this->jump($this->logicHotel->hotelDel($where));
    }
    /**
     * 排序
     */
    ...
    {
        $this->jump($this->logicLtasBase->setSort('Hotel', $this->param));
    }
}
