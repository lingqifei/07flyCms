...
class TmGuideColl extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        $list =$this->logicTmGuideColl->getTmGuideCollList($where);
    ...
    public function add()
    {
        ...
        IS_POST && $this->jump($this->logicTmGuideColl->tmGuideCollAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicTmGuideColl->tmGuideCollEdit($this->param));
        ...
        $info = $this->logicTmGuideColl->getTmGuideCollInfo($where);//团订单详细
    ...
    public function del()
    {
        ...
        $this->jump($this->logicTmGuideColl->tmGuideCollDel($where));
    }
