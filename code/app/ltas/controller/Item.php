...
class Item extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        $list =$this->logicItem->getItemList($where,true,$order_by)->toArray();
        return $list;
    }
    ...
    public function add()
    {
        ...
        IS_POST && $this->jump($this->logicItem->itemAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicItem->itemEdit($this->param));

        $info = $this->logicItem->getItemInfo(['id' => $this->param['id']]);
    ...
    public function del()
    {
        ...
        $this->jump($this->logicItem->itemDel($where));
    }
    /**
     * 排序
     */
    ...
    {
        $this->jump($this->logicLtasBase->setSort('Item', $this->param));
    }
}
