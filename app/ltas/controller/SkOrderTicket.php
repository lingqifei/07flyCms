...
class SkOrderTicket extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        foreach ($list["data"] as $key=>$row){
            $map['order_id']=["=",$row['id']];
            $list['data'][$key]['hotel_list']=$this->logicSkOrderHotel->getSkOrderHotelList( $map );//i酒店信息表
        }
        return $list;
    }
    ...
    public function show_json_to_order()
    {
        ...
        $list=$this->logicSkOrderTicket->getSkOrderTicketList( $where );
    ...
    public function add()
    {
        IS_POST && $this->jump($this->logicSkOrderTicket->skOrderTicketAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicSkOrderTicket->skOrderTicketEdit($this->param));

        //票务列表
        $map['id']=["=", $this->param['id']];
        $info     = $this->logicSkOrderTicket->getSkOrderTicketInfo($map);
