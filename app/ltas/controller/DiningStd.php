...
class DiningStd extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        }else if($orderField=='by_aged_price'){
            $order_by ="aged_price $orderDirection";
        ...
        $list =$this->logicDiningStd->getDiningStdList($where,true,$order_by)->toArray();
        return $list;
    }
    ...
    public function add()
    {
        ...
        IS_POST && $this->jump($this->logicDiningStd->diningStdAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicDiningStd->diningStdEdit($this->param));

        $info = $this->logicDiningStd->getDiningStdInfo(['id' => $this->param['id']]);
    ...
    public function del()
    {
        ...
        $this->jump($this->logicDiningStd->diningStdDel($where));
    }
    /**
     * 排序
     */
    ...
    {
        $this->jump($this->logicLtasBase->setSort('DiningStd', $this->param));
    }
}
