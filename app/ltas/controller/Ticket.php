...
class Ticket extends LtasBase
{
    ...
    public function show_json()
    {
        ...
        $list =$this->logicTicket->getTicketList($where,true,$order_by);
        return $list;
    }
    ...
    public function add()
    {
        ...
        IS_POST && $this->jump($this->logicTicket->ticketAdd($this->param));
    ...
    public function edit()
    {
        ...
        IS_POST && $this->jump($this->logicTicket->ticketEdit($this->param));

        $info = $this->logicTicket->getTicketInfo(['id' => $this->param['id']]);
    ...
    public function del()
    {
        ...
        $this->jump($this->logicTicket->ticketDel($where));
    }
    /**
     * 排序
     */
    ...
    {
        $this->jump($this->logicLtasBase->setSort('Ticket', $this->param));
    }
}
